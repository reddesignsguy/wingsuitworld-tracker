...
export default function Navbar() {
  ...
  return !isLoading ? (
    <>
      ...
      {/* Drop Down Menu */}
      <DropDownMenu menuRef={menuRef} logout={logout} open={open} />
    </>
  ) : null;
}

// Decides if login button or profile picture is shown
function LoggedInComponent(props) {
  const { picRef, open, setOpen } = props;
...
function DropDownMenu(props) {
  const { menuRef, logout, open } = props;
  return (
    <section
